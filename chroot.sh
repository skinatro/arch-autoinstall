...
touch /etc/hostname
echo kuroneko >> /etc/hostname                          cat /etc/hostname       
...
127.0.0.1	localhost
::1		locathost                               127.0.1.1	kuroneko.localdomain kuroneko              

EOF


cat /etc/hosts
                                                                                                                mkinitcpio -p linux-zen                                 passwd root                                             useradd -m kuroneko                                     passwd kuroneko                                         usermod -aG wheel,audio,video,optical,storage kuroneko                                                          mkdir /boot/EFI

...
sudo pacstrap /mnt base linux linux-firmware linux-headers dkms ntfs-3g git base-devel grub efibootmgr dosfstools os-prober mtools bc nvim amd-ucode NetworkManager
